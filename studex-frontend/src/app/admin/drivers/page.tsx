...
export default function AdminDriversPage() {
  ...
  return (
    <div className="flex flex-1 flex-col px-5 pb-8 pt-5">
      <section className="mt-2 rounded-[32px] bg-gradient-to-r from-[#2B1CCF] to-[#4731E6] p-5 text-white shadow-lg">
        <div className="flex items-start justify-between gap-4">
          <div>
            ...
            <p className="mt-3 text-sm leading-6 text-white/85">
              Tinjau pengajuan driver yang masuk dan lakukan approval dari layar mobile.
            </p>
          </div>
